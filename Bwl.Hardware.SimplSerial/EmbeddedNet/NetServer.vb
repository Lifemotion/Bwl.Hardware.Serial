...
''' </summary>
''' <remarks></remarks>
Public NotInheritable Class EmbConnectedClient
...
Friend Class EmbClientData
    Public userInfo As EmbConnectedClient
...
Public Class EmbNetServer
    ...
    Public ReadOnly Property Clients() As List(Of EmbConnectedClient)
        Get
            Dim list As New List(Of EmbConnectedClient)
    ...
    Private Sub AcceptSocket(ByVal data As IAsyncResult)
        ...
        If Not newSocket Is Nothing Then
            ...
            newClient.userInfo = New EmbConnectedClient(endPoint.Address.ToString, GetID, newClient, Me)
    ...
    Private Class MessageClientPack
        ...
        Public client As EmbConnectedClient
    End Class
    ...
    Private Sub ParseBytesInMessage(ByVal client As EmbClientData, ByVal broken As Boolean)
        ...
        End If
    End Sub
    Public Event ClientConnected(ByVal client As EmbConnectedClient)
    Public Event ClientDisonnected(ByVal client As EmbConnectedClient)
    Public Event ReceivedMessage(ByVal message As EmbNetMessage, ByVal client As EmbConnectedClient)
    Public Event SentMessage(ByVal message As EmbNetMessage, ByVal client As EmbConnectedClient)
    ...
    ''' <remarks></remarks>
    Public Overloads Sub SendMessage(ByVal client As EmbConnectedClient, ByVal message As EmbNetMessage)
